...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 587;
        $this->mail->Username = 'siyauk1999@gmail.com';
        $this->mail->Password = 'zrxffjyfbrnktdok';
    }
    ...
    public function sendEmail(){
        ...
        if(empty($usersEmail)){
            flash("reset", "siyauk1999@gmail.com");
        ...
        $url = 'http://localhost/test/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
